...
*/
    ...
    public void get04()  {
        ...
        //Set the Url
        //String url="https://jsonplaceholder.typicode.com/" ==> tavsiye edilmez
        spec.pathParam("first","todos");//spec-->tekrarli islemler icerin RequestSpecification objesi
        ...
        //hasSize() methodu eleman sayisini assert eder.
        //hasItem() methodu contains() gibi tek bir objenin icerilip icerilmedigini assert eder.
        //hasItems() methodu containsAll() gibi coklu  objelerin icerilip icerilmedigini assert eder.
