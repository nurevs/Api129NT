...
*/
    ...
    public void get07() {
        ...
        List<Integer> list=jsonPath.getList("findAll{it.id>190}.id"); //bu listte id'190dan buuyk olan itemleri getir
       //Pront all ids greater than 190 on the console
        System.out.println(list);

        //Assert that there are 10 ids grater than 190
